...
finishedAt | string | Sí | Fecha y hora de finalización
...
startedAt | string | Sí | Fecha y hora del momento en que el verificante ingresa todos sus datos.
...
createdAt | string | No | Fecha y hora de creación
...
updatedAt | string | No | Última fecha y hora en la que se realizó alguna modificación
