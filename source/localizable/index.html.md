...
expirationDatetime | string | Expiración del contrato en Fecha y hora en formato ISO, a partir de la fecha de inicio del contrato.
...
expirationDatetime | string | `optional` Expiración del contrato en Fecha y hora en formato ISO, a partir de la fecha de inicio del contrato.
