...
expirationDatetime | string | Expiración del contrato en Fecha y hora en formato ISO.
...
expirationDatetime | string | `optional` Expiración del contrato en Fecha y hora en formato ISO.
